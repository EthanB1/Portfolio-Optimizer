...
#set tabs for Data to be displayed
tab1, tab2, tab3, = st.tabs(["Portfolio Return",
                                        "Portfolio Data",
                                        "Monte Carlo",
                                        ])
...
with tab1:
    st.header("The Cummulative return of the Portfolio")
    with fig_col1:
...
with tab2:
    st.header("Portforlio Data and Analysis")
    with fig_col3:   
